...
import com.ethpar.pos.sdk.wallet.models.Balance
import com.ethpar.pos.sdk.wallet.models.ConfirmLoginCodeRequest
import com.ethpar.pos.sdk.wallet.models.ConfirmLoginCodeResponse
import com.ethpar.pos.sdk.wallet.models.CreateCCWallet
import com.ethpar.pos.sdk.wallet.models.CreateMultisigTransactionRequest
import com.ethpar.pos.sdk.wallet.models.CreateMultisigWalletRequest
import com.ethpar.pos.sdk.wallet.models.CreditCardMultisigWallet
import com.ethpar.pos.sdk.wallet.models.FeatureFlags
import com.ethpar.pos.sdk.wallet.models.GeneralMultisigWallet
import com.ethpar.pos.sdk.wallet.models.GenerateLoginCodeRequest
import com.ethpar.pos.sdk.wallet.models.GetBalancesRequest
import com.ethpar.pos.sdk.wallet.models.Transaction
import com.ethpar.pos.sdk.wallet.models.PosTransaction
import com.ethpar.pos.sdk.wallet.models.SetUserPublicAddressRequest
import com.ethpar.pos.sdk.wallet.models.SignatureData
import com.ethpar.pos.sdk.wallet.models.TokenInfo
import com.ethpar.pos.sdk.wallet.models.User
